...
coco_od_dataset = dict(
    ...
    return_classes=True,
    type='ODVGDataset')
data_root = '/root/autodl-tmp/workspace/datasets/flir/FLIR_ADAS_1_3/FLIR_ADAS_1_3/flir_3cls_fewshot_export/5shot/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/root/autodl-tmp/workspace/datasets/flir/FLIR_ADAS_1_3/FLIR_ADAS_1_3/flir_3cls_fewshot_export/5shot/',
        metainfo=dict(
            classes=(
                'person',
                'bicycle',
...
test_evaluator = dict(
    ann_file=
    '/root/autodl-tmp/workspace/datasets/flir/FLIR_ADAS_1_3/FLIR_ADAS_1_3/flir_3cls_fewshot_export/5shot/annotations/val.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
work_dir = 'work_dirs/flir_base_5shot_v2'
