...
backend_args = None
class_name = (
    'a bright human silhouette in a FLIR thermal road scene',
    'a two wheeled bicycle with thin structure and weak thermal texture',
    'a road vehicle with large rectangular thermal contour in a FLIR image',
)
...
launcher = 'none'
load_from = 'checkpoints/grounding_dino_swin-t_pretrain_obj365_goldg_grit9m_v3det.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='annotations/val_desc.json',
...
test_evaluator = dict(
    ann_file=
    '/root/autodl-tmp/workspace/datasets/flir/FLIR_ADAS_1_3/FLIR_ADAS_1_3/flir_3cls_fewshot_export/1shot/annotations/val_desc.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
        ann_file='annotations/train_odvg.jsonl',
        backend_args=None,
        data_prefix=dict(img='train/'),
        data_root=
        '/root/autodl-tmp/workspace/datasets/flir/FLIR_ADAS_1_3/FLIR_ADAS_1_3/flir_3cls_fewshot_export/1shot/',
        filter_cfg=dict(filter_empty_gt=False),
        label_map_file='annotations/flir_desc_label_map.json',
        pipeline=[
            dict(backend_args=None, type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(prob=0.5, type='RandomFlip'),
...
work_dir = 'work_dirs/flir_desc_1shot_debug'
